...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, arc=.35mm, breakable, toprule=.15mm, left=2mm, coltitle=black, toptitle=1mm, opacityback=0, opacitybacktitle=0.6, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{📊 Challenge Requirements}, colframe=quarto-callout-important-color-frame, leftrule=.75mm, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, arc=.35mm, breakable, toprule=.15mm, left=2mm, coltitle=black, toptitle=1mm, opacityback=0, opacitybacktitle=0.6, bottomtitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{⚠️ AI Partnership Required}, colframe=quarto-callout-warning-color-frame, leftrule=.75mm, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, colback=white]
