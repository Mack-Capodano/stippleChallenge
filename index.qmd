...
#| echo: true
#| fig-cap: "High sigma stippling experiment (σ=1.2)"
#| fig-width: 7
#| fig-height: 4
...
axes[2].axis('off')
axes[2].set_title('High Sigma (σ=1.2)', fontsize=14, fontweight='bold', pad=10)
...
#| echo: true
#| fig-cap: "Low sigma stippling experiment (σ=0.5)"
#| fig-width: 7
#| fig-height: 4
...
axes[2].axis('off')
axes[2].set_title('Low Sigma (σ=0.5)', fontsize=14, fontweight='bold', pad=10)
